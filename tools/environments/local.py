...
def _make_run_env(env: dict) -> dict:
    ...
    # only makes sense on POSIX. Use os.name (not a test-patchable _IS_WINDOWS
    # flag) so unit tests on Windows hosts that patch _IS_WINDOWS still use
    # os.pathsep correctly.
    if os.name == "posix":
